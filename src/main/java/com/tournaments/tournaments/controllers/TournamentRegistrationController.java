...
public class TournamentRegistrationController {
    ...
    public ResponseEntity<List<TrainerDTO>> getRegistrationsByTournamentId(@PathVariable("tournamentId") Integer tournamentId) {
        List<TrainerDTO> registrations = tournamentRegistrationService.getRegistrationsByTournamentId(tournamentId);
